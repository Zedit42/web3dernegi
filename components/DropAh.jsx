  ...
  return (
    ...
    >
      <div
        ...
        className=" max-w-[14rem] py-4 px-6 mb-4 shadow rounded bg-blue-600 hover:bg-blue-600/90 font-medium leading-none text-white text-center flex items-center justify-center mx-auto cursor-pointer"
      >
        Tweet For Afad
